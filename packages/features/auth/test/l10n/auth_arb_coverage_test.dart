...
/// The #33 key-coverage check for the auth feature's ARB files —
...
void main() {
  group('auth ARB coverage', () {
    ...
    test('the template defines at least the auth key surface', () {
      expect(report.templateKeys, isNotEmpty);
      expect(report.templateKeys, contains('authSignInTitle'));
    });
