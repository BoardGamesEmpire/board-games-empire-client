...
///
/// Absent from a container that runs no drain at all (see
/// `HouseholdHydrateInstaller` for which those are), which the screens read as
/// "no retry to offer" rather than offering a button that does nothing.
